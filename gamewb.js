//http://blog.csdn.net/renfufei/article/details/17657093
//fullscreen      
            ...
            var width  = 4;
            var height = 4;
			var kinds  = 7; 			//使用块种类 取值 2-7 默认7 越大越难
										//主流游戏目前多使用6 
			var CardWidth = 100;
			var CardHeight = 44;
			...
			var timedCount = function(){
				...
				drawtext(times,CardWidth*width+90,150,"#ffffff");
			}
...
//            };
            ...
            var draw=function(){
				...
				drawtext('移动步数',CardWidth*width+90,90,"#cc0033");
				drawtext('本关用时',CardWidth*width+90,130,"#cc0033");
				drawtext(score,CardWidth*width+90,70,"#ffffff");
				drawtext(steps,CardWidth*width+90,110,"#ffffff");
...
//						context.shadowColor="rgba(255,255,255,0.4)";
			...
			//alert('www');
				...
				alert(event.touches[0].clientX);
                    var x=event.touches[0].clientX-10;
