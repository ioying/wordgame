...
<html>
	...
	<img id="bs1" src="./images/g1.png"  />
	<img id="bs2" src="./images/g7.png"  />
	<img id="bs3" src="./images/g3.png"  />
	<img id="bs4" src="./images/g4.png"  />
	<img id="bs5" src="./images/g5.png"  />
	<img id="bs6" src="./images/g6.png"  />
	<img id="bs7" src="./images/g7.png"  />

	</div>
		<div id='bg1' style="background-size:927px 480px;position:absolute; top:50px;" onclick='this.style.display = "none";'>
		  
		  <img src="./images/redbg.png">
		</div>
		<div id='bg' style="background:url(./images/golf.gif);background-repeat:no-repeat;background-size:927px 480px;">
		...
		<script>
			var showword = <?php echo getWordFromCsv('/wordgame/','golf.csv');?>;
		</script>				
        <script>
